        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '20px', flex: 1 }}>
          ...
          <div style={{ background: '#f1f5f9', border: '1px solid #cbd5e1', padding: '20px', borderRadius: '12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div>
              ...
              <div style={{ fontSize: '1.65rem', fontWeight: 800, color: 'hsl(var(--color-primary))' }}>{formatCurrency(netSalary)}</div>
            </div>
            <button
              type="submit"
              disabled={submitting}
              style={{
                ...
                alignItems: 'center',
                gap: '8px',
                boxShadow: '0 4px 6px -1px rgba(255, 107, 0, 0.25)'
              }}
            >
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', alignItems: 'center', justifyContent: 'center', padding: '50px', color: '#ef4444' }}>
        ...
        <button 
          ...
          style={{ padding: '10px 20px', background: 'linear-gradient(135deg, hsl(var(--color-primary)), #e65c00)', color: '#fff', border: 'none', borderRadius: '8px', cursor: 'pointer', fontWeight: 700, boxShadow: '0 2px 8px rgba(255, 107, 0, 0.2)' }}
        >
          Retry
        </button>
      </div>
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '28px', background: '#ffffff', color: '#0f172a' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: '20px' }}>
        {(() => {
          const cards = [];
          if (type === 'Teacher') {
            cards.push({ label: 'Total Teachers', val: summary.totalTeachers, icon: UserCheck, color: 'rgba(255, 107, 0, 0.08)', iconColor: 'hsl(var(--color-primary))' });
          } else if (type === 'Staff') {
      ...
      <div style={{ background: '#ffffff', color: '#0f172a', width: '100%', maxWidth: '720px', borderRadius: '16px', display: 'flex', flexDirection: 'column', height: '90vh', overflow: 'hidden', border: '1px solid #cbd5e1', boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }}>
        ...
        <div style={{ padding: '18px 24px', background: '#f8fafc', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e2e8f0' }}>
          ...
          <div style={{ display: 'flex', gap: '10px' }}>
            <button 
              onClick={handlePrint}
              style={{ padding: '10px 18px', border: 'none', background: 'linear-gradient(135deg, hsl(var(--color-primary)), #e65c00)', color: '#fff', borderRadius: '8px', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', boxShadow: '0 2px 4px rgba(255, 107, 0, 0.2)' }}
            >
