            ...
            <div class="card-body">
              <div class="avatar-container">
                ${teacher.photo ? `<img class="avatar" src="${teacher.photo}" />` : `
                  <div class="avatar-placeholder">
                    ${(teacher.fullName || teacher.name || 'S').split(' ').map(n => n[0]).join('').substring(0, 2).toUpperCase()}
                  </div>
                `}
              </div>
              <div class="name">${teacher.fullName || teacher.name}</div>
              <div class="role-badge">${teacher.role || 'Staff'}</div>
              ...
              <div class="meta-info">
                ...
                <div class="meta-item">
                  ...
                  <span class="meta-value">${teacher.department || 'Administration'}</span>
                </div>
              </div>
            </div>
